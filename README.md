...
на фикстурах и мок-транспорте. Живое подключение к Jira и к API Anthropic не проверялось — нет доступа;
остальное работает на синтетических данных. Подробности в `PLAN.md`.
...
`flowlens serve` поднимает веб-интерфейс с девятью вкладками:

| Вкладка | Что показывает |
|---|---|
| Обзор | ключевые показатели, текстовый разбор, наблюдения по правилам |
| Поток | накопительная диаграмма, поступление против закрытия |
| Время цикла | распределение с перцентилями, самые долгие задачи |
| Где время | медиана по фазам, соотношение работы и ожидания |
