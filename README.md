...
Завершены этапы 1–6: фундамент расчётов, коллектор Jira, согласование данных,
API и дашборд, наблюдения по правилам, вероятностные прогнозы.
Живое подключение к Jira не проверялось (нет доступа) — коллектор протестирован
на фикстурах и мок-транспорте. Дальше — текстовый разбор, см. `PLAN.md`.
